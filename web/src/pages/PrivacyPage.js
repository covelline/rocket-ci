...
const content = `
合同会社コベリン（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下，「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
...
- 社名：合同会社コベリン
- Eメールアドレス：info[at]covelline.com

---

# 利用している外部サービス

合同会社コベリン（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下，「本サービス」といいます。）において顧客情報の一部は下記に記載するサービスに提供しております。 これらは本サービスのサービス運営，カスタマーサポート，サービス改善にのみ利用されています。
